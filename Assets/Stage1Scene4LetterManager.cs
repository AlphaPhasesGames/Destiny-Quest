...
{
    public class Stage1Scene4LetterManager : MonoBehaviour
    {
        public Stage1Scene4TextMan s1TextMan;
        [Header("Letter Pages")]
        ...
        {
            LOLSDK.Instance.SpeakText("politicalEcoCultureLetter1");
            Debug.Log("This TTS Worked");
        }

        public void PlayTTSLetter2()
        {
            LOLSDK.Instance.SpeakText("politicalEcoCultureLetter2");
            Debug.Log("This TTS Worked");
        }

        public void PlayTTSLetter3()
        {
            LOLSDK.Instance.SpeakText("politicalEcoCultureLetter3");
            Debug.Log("This TTS Worked");
        }
