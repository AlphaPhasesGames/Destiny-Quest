...
namespace Alpha.Phases.Destiny.Quest
{
    public class Stage2LetterManager : MonoBehaviour
    {
        ...
        public void CloseLetter()
        {
            ...
            s2TextMan.positionChanged = true;
            s2TextMan.arrayPos = 2;
        }

        public void PlayTTSLetter1()
        {
            LOLSDK.Instance.SpeakText("oregonLetter1");
            Debug.Log("This TTS Worked");
        }

        public void PlayTTSLetter2()
        {
            LOLSDK.Instance.SpeakText("oregonLetter2");
            Debug.Log("This TTS Worked");
        }

        public void PlayTTSLetter3()
        {
            LOLSDK.Instance.SpeakText("oregonLetter3");
            Debug.Log("This TTS Worked");
        }

        public void PlayTTSLetter4()
        {
            LOLSDK.Instance.SpeakText("oregonLetter4");
            Debug.Log("This TTS Worked");
        }
