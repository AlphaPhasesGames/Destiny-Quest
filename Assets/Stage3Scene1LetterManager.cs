...
{
    public class Stage3Scene1LetterManager : MonoBehaviour
    {
        ...
        {
            LOLSDK.Instance.SpeakText("texasLetter1");
            Debug.Log("This TTS Worked");
        }

        public void PlayTTSLetter2()
        {
            LOLSDK.Instance.SpeakText("texasLetter2");
            Debug.Log("This TTS Worked");
        }

        public void PlayTTSLetter3()
        {
            LOLSDK.Instance.SpeakText("texasLetter3");
            Debug.Log("This TTS Worked");
        }
