...
namespace Alpha.Phases.Destiny.Quest
{
    public class Stage3InventoryManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            ttsBulletPoint1Book7.onClick.AddListener(PlayTTSBulletPoint1Book6);
            ttsBulletPoint2Book7.onClick.AddListener(PlayTTSBulletPoint2Book6);
            ttsBulletPoint3Book7.onClick.AddListener(PlayTTSBulletPoint3Book6);
            ttsBulletPoint4Book7.onClick.AddListener(PlayTTSBulletPoint4Book6);
            ttsBulletPoint5Book7.onClick.AddListener(PlayTTSBulletPoint5Book6);
            ttsBulletPoint6Book7.onClick.AddListener(PlayTTSBulletPoint6Book6);
        }
