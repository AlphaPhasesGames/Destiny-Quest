...
{
    public class Stage2Scene3TextMan : MonoBehaviour
    {
        ...
        public Button choice1Answer1Stay;
        ...
        private void HandleArrayPosActions()
        {
            switch (arrayPos)
            {
                case 0:
                    if (!submitOnce)
                    {
                        LOLSDK.Instance.SubmitProgress(0, 56, 100);
                        submitOnce = true;
                    }
        ...
        {
            string textKey = $"stage2Scene3Text{textIndex}";
            LOLSDK.Instance.SpeakText(textKey);
            Debug.Log($"stage2Scene3Text{textIndex} Button is pressed");
        }
        ...
        public void ProgressTextForward()
        {
            if (arrayPos < maxLengthArray - 1)
            {
                ...
                if (arrayPos != 1 && arrayPos != 5 && arrayPos != 2)
                {
                    StartCoroutine(DelayTextButton());
                }
            }
